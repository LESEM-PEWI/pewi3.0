...
(function($) {
    ...
    Progressbar.prototype.transition = function() {
        ...
        var currentParentBoxInfo = $this.parent().css("box-shadow");
        var currentParentBorderInfo = $this.parent().css("border");


       //trying to make it red if decreasing and green if increasing, values for the percent variables are weird
       ...
       // The last two conditions are to keep the border from turning green when the value decreases from 100 and from turning red when it is increasing to 100
        if((percentage < current_percentage || (current_percentage == 100 && percentage < 100)) && !(percentage == 100 && current_percentage < 100))
        {
          ...
          $this.parent().css("box-shadow", "0 0 10px 3px red");
          $this.parent().css("border","red");
        }

        else if(percentage > current_percentage || (percentage == 100 && current_percentage < 100))
        {
          $this.css("border", "5px solid green");
          $this.parent().css("box-shadow", "0 0 10px 3px green");
          $this.parent().css("border","green");
        }
        ...
        setTimeout(function(){
           ...
           $this.parent().css("box-shadow", currentParentBoxInfo),
           $this.parent().css("border", currentParentBorderInfo)
        }, 1000);
