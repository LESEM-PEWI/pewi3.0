    ...
    Progressbar.prototype.transition = function() {
        ...
        setTimeout(function() {
            ...
            var progress = setInterval(function() {
                ...
                // I am trying to figure out what these values are

                console.log("percentage: " + percentage + ", current_percentage: " + current_percentage + ", prev_percentage: " + prev_percentage);
                ...
                else if (current_percentage < prev_percentage)
                {
                  decreasing = true;
                }
