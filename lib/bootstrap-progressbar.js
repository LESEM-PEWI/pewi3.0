...
(function($) {
    ...
    Progressbar.prototype.transition = function() {
        ...
        var percentage = (100 * (data_transitiongoal - aria_valuemin) / (aria_valuemax - aria_valuemin)).toFixed(2);
        ...
        setTimeout(function() {
            ...
            var progress = setInterval(function() {
                ...
                current_percentage = parseFloat(100 * this_size / parent_size).toFixed(2);
                ...
                if (current_percentage >= percentage || prev_percentage == current_percentage) {
                    ...
                    console.log('Done at percentage:  ', current_percentage);
                    done($this);
