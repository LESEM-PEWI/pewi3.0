...
var dataset = [
  { label: 'Conventional Corn', count:  (Math.round(Totals.landUseResults[1]['conventionalCornLandUse'] / Totals.totalArea * 100 * 10) / 10)}, 
  { label: 'Conservation Corn', count: (Math.round(Totals.landUseResults[1]['conservationCornLandUse'] / Totals.totalArea * 100 * 10) / 10) },
  { label: 'Conventional Soybean', count: (Math.round(Totals.landUseResults[1]['conventionalSoybeanLandUse'] / Totals.totalArea * 100 * 10) / 10) },
  { label: 'Conservation Soybean', count: (Math.round(Totals.landUseResults[1]['conservationSoybeanLandUse'] / Totals.totalArea * 100 * 10) / 10) },
  { label: 'Mixed Fruits/Vegetables', count:  (Math.round(Totals.landUseResults[1]['mixedFruitsVegetablesLandUse'] / Totals.totalArea * 100 * 10) / 10)}, 
  { label: 'Permanent Pasture', count: (Math.round(Totals.landUseResults[1]['permanentPastureLandUse'] / Totals.totalArea * 100 * 10) / 10) },
  { label: 'Rotational Grazing', count: (Math.round(Totals.landUseResults[1]['rotationalGrazingLandUse'] / Totals.totalArea * 100 * 10) / 10) },
  { label: 'Grass Hay', count: (Math.round(Totals.landUseResults[1]['grassHayLandUse'] / Totals.totalArea * 100 * 10) / 10) },
  { label: 'Switchgrass', count:  (Math.round(Totals.landUseResults[1]['switchgrassLandUse'] / Totals.totalArea * 100 * 10) / 10)}, 
  { label: 'Prairie', count: (Math.round(Totals.landUseResults[1]['prairieLandUse'] / Totals.totalArea * 100 * 10) / 10) },
  { label: 'Wetland', count: (Math.round(Totals.landUseResults[1]['wetlandLandUse'] / Totals.totalArea * 100 * 10) / 10) },
  { label: 'Alfalfa', count: (Math.round(Totals.landUseResults[1]['alfalfaLandUse'] / Totals.totalArea * 100 * 10) / 10) },
  { label: 'Conventional Forest', count:  (Math.round(Totals.landUseResults[1]['conventionalForestLandUse'] / Totals.totalArea * 100 * 10) / 10)}, 
  { label: 'Conservation Forest', count: (Math.round(Totals.landUseResults[1]['conservationForestLandUse'] / Totals.totalArea * 100 * 10) / 10) },
  { label: 'SR Woody Bioenergy', count: (Math.round(Totals.landUseResults[1]['shortRotationWoodyBioenergyLandUse'] / Totals.totalArea * 100 * 10) / 10) }
];    
...
var svg = d3.select(document.getElementById('resultsFrame').contentWindow.document.getElementById('chart'))
  .append('svg')
