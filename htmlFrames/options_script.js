  ...
  */
  ...
  var hotkeyDescrip = ["Resets Camera","Randomize PEWI map","Toggle Topography","Undo Previous Land Change","Toggle Recording Feature","Create Multiplayer Maps",
      "Print","Move Right","Move Left","Move Forward","Move Backward","Toggle Overlay","Toggle Flying Mode","Pivot Flat","Pivot Upright","Rotate Counterclockwise","Rotate Clockwise","Toggle Contour Map"];
